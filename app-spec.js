...
describe ('getSpouse', function(){
  ...
  it ('null', function(){
    //condition=currentSpouse is null
...
var uma = {
  ...
  "currentSpouse": 272822514
    ...
    expect(getParentOne(jill, people)).toEqual("Uma Bob");
});
});
...
var uma = {
  ...
  "currentSpouse": 272822514
    ...
    expect(getParentOne(uma, people)).toEqual([jill,ralph]);
});
});
...
"currentSpouse": 951747547
    ...
    expect(findPerson("", "Bob", people)).toEqual(selectedPerson);
  });
});
